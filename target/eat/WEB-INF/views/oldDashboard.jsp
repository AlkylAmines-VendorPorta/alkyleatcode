 ...
 <div id="preloader"></div>
    ...
    <div class="header">
        <div class="container-fluid">
			...
			<div class="welcome pull-right"> <span class="glyphicon glyphicon-user" style="color:#fff"></span> Welcome MSCDCL_User |<a href="logout">Logout</a></div>
        </div>
    </div>
    <!-- Header end -->
    <div class="clearfix"></div>
    ...
    <div class="full-container animated slideInLeft">
        ...
        <div id="MainProductTiles" class="container top20">
            <a href="javascript:void(0)" class="col-md-3">
             ...
             <a href="mastertiles" class="col-md-3">
                <div class="tiles text-center">
                    <i class="fa fa-fw fa-dashboard pull-left font36"></i>
            ...
            <a href="tendertiles" class="col-md-3">
                <div class="tiles text-center">
            ...
            <a href="bidstiles" class="col-md-3">
                <div class="tiles text-center">
            ...
            <a href="Vendortiles.html" class="col-md-3">
                <div class="tiles text-center">
                    <i class="fa fa-user pull-left font36"></i>
            ...
            <a href="" class="col-md-3">
             ...
             <a href="Usertiles.html" class="col-md-3">
                <div class="tiles text-center">
