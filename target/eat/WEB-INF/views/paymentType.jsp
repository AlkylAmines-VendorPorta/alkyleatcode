          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Payment Details</a> </h4>
              </div>
              <div id="collapse1" class="panel-collapse collapse in">
               ...
               <div class="col-sm-4">
                    <div class="styled-input">
                        <input type="text" id=""  class="Amount" required="required" />
                  ...
                  <div class="col-md-4 col-xs-12">
                    <label class="checkbox-inline">
                      <input type="checkbox" value=""  class="periodType"  disabled="disabled">
                      Period Type </label>
                  </div>  
                  ...
                  <div class="col-md-6 col-xs-12">
                    <label class="checkbox-inline">
                      <input type="checkbox" value="" class="refundable" disabled="disabled">
                      Refundable </label>
                  </div>
                   </div>
                  <div class="clearfix"></div>
...
<script src="<%=request.getContextPath()%>/resource/js/paymenttype.js?appVer=${appVer}"></script>
