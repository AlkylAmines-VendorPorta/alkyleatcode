        ...
        <div class="full-container">
            ...
            <div class="detailsheader leftPaneHeader">
				...
				<c:if test="${documentType.equalsIgnoreCase('Quick Request For Proposal')}">
					<input type="radio" name="toggleTenderType" checked style="display:none;" value="QRFQ" >
				</c:if>
            ...
            <div class="detailsheader toptabbrd">
        		<div class="col-sm-9 text-center"><label>Submission Details</label></div>
        	 </div>
                <div class="clearfix"></div>
                            ...
                            <div class="posrelative">
                              <div class="demo-section k-content">
                                    <div id="tabstrip" class="Firsttab">
                                        <ul id="tabUL">
                                            <!-- tabs -->
                                            <li data-parentTab="" id="tahdrDetailsTab" class="k-state-active"> Details</li>
                                           
                                            <li class="tahdrTab toggleTab" data-parentTab="tahdrDetailsTab" id="deliveryDetailTab" onclick="onClickCommercialBid();">Commercial Details</li>
                                        ...
                                        <div class="detailscont">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                   <%--  <button class="btn btn-default" id="tahdrDoc" data-id="" onclick="downloadTahdrDetailDoc();">View ${documentType} Details</button> --%>
									         ...
									         <div class="detailscont">
									          ...
									          <div class="col-sm-12">
									               	<ul class="nav nav-pills col-md-12 comBidTab">
														<li id="deliveryDetailTab" class="active" data-placement="right" data-toggle="tooltip" title="Delivery Details" ><a href="#tab_h" data-toggle="pill"><i class="fa fa-gavel"></i></a><label>Delivery Details</label></li>
													</ul>
