        ...
        <div class="full-container">
        	...
        	<div class="col-sm-3 text-center brdrgt"><label>Auction Report (0)</label></div>
                ...
                <div class="btn-group btnmrg" data-toggle="buttons">
                				<c:if
									test="${isForwardAuctionActive.equalsIgnoreCase('Y')}">
								    <label class="btn btn-primary active toggleTab" openTab="tenderTab">
										<input type="radio" name="tenderTypeCodeToggle" checked="checked"  value="QFA" id="option3">
										<span class="glyphicon glyphicon-ok"></span> Quick Forward 
	                                </label>
                                </c:if>
                                <c:if
									test="${isReverseAuctionActive.equalsIgnoreCase('Y')}">
									 <label class="btn btn-primary toggleTab" openTab="tenderTab">
	                                     <input type="radio" name="tenderTypeCodeToggle" value="QRA" id="option3">
				...
				<div class="tab-content col-md-12">
					<div class="tab-pane active" id="tab_h">
                               ...
                               <!--  <div class="col-sm-12 bottom20">
                                ...
                                <form id="tenderDetailsForm" class="readonly">
                                	<div class="form-group">
                                                <div class="col-sm-4">
                                                        ...
                                                        <label>Auction No:</label>
                                                        <span class="detspan" id="tahdrNo"></span>
                                                </div>
                                                <div class="col-sm-4">
                                                 <label>Total Unit Quatity :</label>
                                                        <span class="detspan" id="qtyId">0</span>
                                                   
                                                </div>
                                                <div class="col-sm-4">
                                                 <label id="decOrIncByLblId">:</label>
                                                        <span class="detspan" id="decOrIncById">0 </span>
                                                  
                                                </div>
                                                </div>
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                 <label>No of Bidders: </label>
                                                        <span class="detspan" id="noOfBidderId">0</span>
                                                  
                                                </div>
                                            
                                                <div class="col-sm-4">
                                                 <label>Bid Start Date:</label>
                                                        <span class="detspan" id="bidStartDateId"> </span>
                                                  
                                                </div>
                                                 <div class="col-sm-4">
                                                 <label>Bid End Date:</label>
                                                        <span class="detspan" id="bidEndDateId"> </span>
                                            ...
                                            <div class="col-sm-4">
                                                 <label>Auction Location: </label>
                                                        <span class="detspan" id="location"> </span>
                                                  
                                                </div>
                                             <div class="col-sm-4">
                                                 <label>My Pseudo Name: </label>
                                                        <span class="detspan" id="psuedoName"> </span>
                                ...
                                <div class="col-sm-12 bottom20">
                                <div class="card">
                                <h4 class="col-sm-12">Bid Details</h4>
                                ...
                                <input type="text" style="display: none ;" id="tahdrId" name="itemBid.bidder.tahdr.tahdrId">
                                 <input type="text" style="display: none ;" id="fddRateWithGST" name="fddRateWithGST">
                                  <input type="text" style="display: none ;" id="preTotalFDDAmountWithGST" name="previousFddAmountWithGST">
                                   <!-- <input type="text" style="display: none ;" id="auctionEndDate" name="itemBid.tahdrMaterial.tahdrDetail.auctionToDate"> -->
                                    <input type="text" style="display: none ;" id="bidderOfferQty" name="offeredQuantity">
                                    <input type="text" style="display: none ;" id="" value="0" name="freightChargeRate">
                                    <input type="text" style="display: none ;" id="" value="0" name="ticRate">
                                  
                                <div class="form-group">
                                	<label class="col-sm-3">Bid Amount</label>
                                	<div class="col-sm-4">
                                	 <table ><tbody>
										<tr><!-- onkeyup="calculate()" -->
										<th><button class="btn btn-default" type="button" onclick="resetToPreviousBid()" >
										<span id="" class="glyphicon glyphicon-refresh"></span></button></th>
										<th><input type="text" id="inputExGroupPriceRateId" data-times="1"  class="form-control tinput onlyNumber requiredField readonly" value="" name="exGroupPriceRate"></th>
										<th> <button class="btn btn-default" type="button" onclick="setNewBid()" >
										<span id="incrementBtnId" class="glyphicon glyphicon-plus"></span>
										<span id="decrementBtnId" class="glyphicon glyphicon-minus"></span>
										</button></th>
										
								       </tr>         		 
								     </tbody> </table>
                                	
                                	<!-- <input type="text" id="inputExGroupPriceRateId" onkeyup="calculate()" class="form-control tinput onlyNumber requiredField readonly" value="" name="exGroupPriceRate"> -->
                                	</div>
                                	<div class="col-sm-4">
                                	   <!--  <button class="btn btn-default" type="button" onclick="setNewBid()" ><span class="glyphicon glyphicon-plus"></span></button> -->
                                		<button type="button" id="newBidSubmitBtnId" onclick="newBidSubmit()" class="btn btn-default bluebutton bidBtnId">Bid</button>
                                		<button type="button" onclick="refreshsBid()" class="btn btn-default bluebutton resetBidBtnId">Refresh</button>
                                	...
                                	<!-- <div class="col-sm-4">
                                	    <button type="button" onclick="resetToPreviousBid()" class="btn btn-default bluebutton resetBidBtnId">Refresh</button>
                                		<button type="button"  id="bidHistoryIconId" onclick="return submitWithTwoParam('getBidderListByTahdrId','tahdrId','itemDetailForm #tahdrMaterialId','bidderListResp');" class="btn btn-default bluebutton">Bid History</button>
                                	</div> -->
                                </div>
                                </sf:form>
                                ...
                                <div  class="readonly"> 
                                	<div class="form-group">
                                                ...
                                                <label>My Rank:</label>
                                                <span class="red" id="rank" style="font-size:16px;" >NA</span>
                                                </div>
                                                <div class="col-sm-4">
                                                 <label id="decOrIncByLblId">:</label>
                                                        <span class="detspan" id="decOrIncById">0 </span>
                                               ...
                                               <!--  <div class="col-sm-4">
                                                 <label>Quantity Proposed: </label>
                                                        <span class="detspan" id="offeredQuantity">0</span>
                                                   
                                                </div> -->
                                                <div class="col-sm-4">
	                                                 <label>Bid Amount :</label>
	                                                 <span class="detspan" id="exGroupPriceRate"> </span>
                                                </div>
                                           ...
                                           <div class="form-group">
                                                <div class="col-sm-4">
                                                 <label>Total Bid Amount :</label>
                                                        <span class="detspan" id="totalExGroupPrice"> </span>
                                                  
                                                </div>
                                                
                                            
                                              <!--   <div class="col-sm-4">
                                                 <label>Per Unit TIC(in Rs) :</label>
                                                        <span class="detspan" id="ticRate"> </span>
                                                  
                                                </div>
                                                <div class="col-sm-4">
                                                 <label>Total TIC(in Rs) :</label>
                                                        <span class="detspan" id="totalTic"> </span>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                 <label>Per Unit Freight charges(in Rs) : </label>
                                                        <span class="detspan" id="freightChargeRate"></span>
                                                  
                                                </div>
                                                <div class="col-sm-4">
                                                 <label>Total Freight charges(in Rs) : </label>
                                                        <span class="detspan" id="totalFreightCharges"></span>
                                                  
                                                </div>
                                            
                                                <div class="col-sm-4">
                                                 <label>Per Unit FDD Price Without GST(in Rs) : </label>
                                                        <span class="detspan" id="fddRate"></span>
											...
											<!-- <div class="form-group">
                                                <div class="col-sm-4">
                                                 <label>Total FDD Price Without GST(in Rs) : </label>
                                                        <span class="detspan" id="fddAmount"></span>
                                                  
                                                </div>
                                            
                                                <div class="col-sm-4">
                                                 <label>GST(in %) :</label>
                                                        <span class="detspan" id="taxRate"> </span>
                                                  
                                                </div>
                                                <div class="col-sm-4">
                                                 <label>IGST(in %) <span id="igstLable"> </span>: </label>
                                                        <span class="detspan" id="igst"></span>
											 ...
											 <!-- <div class="form-group">
                                                <div class="col-sm-4">
                                                 <label>CGST(in %)  <span id="cgstLable"> </span>:</label>
                                                        <span class="detspan" id="cgst"> </span>
                                                  
                                                </div>
                                                <div class="col-sm-4">
                                                 <label>SGST(in %)  <span id="sgstLable"> </span>: </label>
                                                        <span class="detspan" id="sgst"></span>
                                                  
                                                </div>
                                            
                                                <div class="col-sm-4">
                                                 <label>Per Unit GST(in Rs) :</label>
                                                        <span class="detspan" id="taxAmount"> </span>
											...
											<!-- <div class="form-group">
                                                <div class="col-sm-4">
                                                 <label>Total GST(in Rs) : </label>
                                                        <span class="detspan" id="totalTax"></span>
                                                  
                                                </div>
                                            -->
                                                <div class="col-sm-4" style="display :none">
                                                 <label>Per Unit FDD With GST(in Rs) :</label>
                                                        <span class="detspan" id="fddRateGST"> </span>
                                                   <input type="text" style="display: none ;" id="fddRateGST_input"/>
                                                </div>
                                              <!--  <div class="col-sm-4">
                                                 <label>Total FDD With GST(in Rs) : </label>
                                                        <span class="detspan" id="fddAmountGST"></span>
                                ...
                                <form id="tenderDetailsForm" class="readonly">
                                	<div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <!--  <div class="col-sm-4">
                                                 <label>First Bid End Date:</label>
                                                        <span class="detspan" id="bidEndDateId"> </span>
...
<script src="<%=request.getContextPath()%>/resources/transaction/js/quickLiveBid.js"></script>
 <script src="<%=request.getContextPath()%>/resources/transaction/js/quickLiveBiding.js"></script> 
