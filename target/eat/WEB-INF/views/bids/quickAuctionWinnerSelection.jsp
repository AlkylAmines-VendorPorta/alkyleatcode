...
<link rel="stylesheet" href="<%=context%>/resources/tilescommon/css/fioristyle.css"/>
<link rel="stylesheet" href="<%=context%>/resources/tilescommon/css//borderTab.css">
<link rel="stylesheet" href="<%=context%>/resources/tilescommon/css/jquery-ui.css">
 <link rel="stylesheet" href="<%=context%>/resources/tilescommon/css/examples.css"/> 
 <link rel="stylesheet" href="<%=context%>/resources/tilescommon/css/fontawesome-stars.css"/>
<script src="<%=context%>/resources/commons/js/springform.js"></script>
<script src="<%=context%>/resources/commons/js/utility.js"></script>
<script src="<%=context%>/resources/commons/js/loadList.js"></script>
<script src="<%=context%>/resources/commons/js/loadItemList.js"></script>
<script src="<%=context%>/resources/commons/js/formFields.js"></script>
<script src="<%=context%>/resources/partner/js/uploadFile.js"></script>
<script src="<%=context%>/resources/tilescommon/js/jquery-ui.js"></script>
<script src="<%=context%>/resources/tilescommon/js/moment.js"></script>
<script src="<%=context%>/resources/tilescommon/js/bootstrap-datetimepicker.js"></script>
<script src="<%=context%>/resources/tilescommon/js/bootstrap-datepicker.js"></script>
<script src="<%=context%>/resources/transaction/js/quickAuctionWinnerSelection.js"></script>
<script src="<%=context%>/resources/transaction/js/awardWinnerTahdrDetails.js"></script>
<script src="<%=context%>/resources/transaction/js/awardWinnerTahdrMaterial.js"></script>
<script src="<%=context%>/resources/transaction/js/awardWinnerMaterialBidder.js"></script>
<script src="<%=context%>/resources/tilescommon/js/jquery.barrating.js"></script> 
<%-- <script src="<%=context%>/resources/transaction/js/rating.js"></script> --%> 
<script src="<%=request.getContextPath()%>/resources/tilescommon/js/number-starRating.js"></script>
        ...
        <div class="full-container">
                ...
                <div class="input-group">
                 ...
                 <input type="hidden" class="documentType" value="${documentType}" />
	                <div class="btn-group btnmrg" data-toggle="buttons">
					    <label class="btn btn-primary toggleNewTab" openTab="tenderDet">
							<input type="radio" name="tenderTypeCodeToggle" value="PT">
							<span class="glyphicon glyphicon-ok"></span> Procurement 
	                    </label>
	                    <label class="btn btn-primary active toggleNewTab" openTab="tenderDet">
                        ...
                        <div class="card">
                           ...
                           <div class="demo-section k-content">
                                    <div id="tabstrip" class="Firsttab">
                                        <ul>
                                            <!-- tabs -->
                                            <li class="k-state-active tenderDet">${documentType} Details</li>
                                            <li class="winnerItems" id="winnerItem" openTab="ItemsofTahdrs">Winner Selection</li>
                                             <c:if test="${type == 'winnerSelection'}">
                                           		<li class="winnerConfirmationTab">Winner Confirmation</li>
                                            </c:if>
                                        </ul>
									...
									<sf:form class="" id="tahdrForm" action="createTahdr" method="POST" autocomplete="off" modelAttribute="tahdr">
										...
										<div id="tenderBaseForm">
											<div class="form-group">
												...
												<!-- <div class="col-sm-4">
													<div class="styled-input">
														<input type="text" id="EMD" name="" value="0" readonly="readonly" />
												...
												<div class="col-sm-4">
													<div class="styled-input">
														<input type="text" id="tahdrStatus" name="" value="0" readonly="readonly" />
														<label>Tender Status<span class="red">*</span></label>
														<span></span>
													</div>
												</div>
			...
			<div id="partsTab">
               ...
               <!-- <div class="col-sm-4 purchased">
				...
				<div class="col-sm-4">
					<div class="styled-input">
						<input type="text" id="fddAmountGST" name="" value="" readonly="readonly" />
							<label>Bid Amount<span class="red">*</span></label>
								<span></span>
					</div>
				</div>
				<!-- <div class="col-sm-4">
				...
				<div class="col-sm-4">
					<div class="styled-input">
						<input type="text" id="bidderStatus" value="" readonly="readonly" />
							<label>Bidder Status<span class="red">*</span></label>
								<span></span>
					</div>
				</div>
				<!-- <div class="col-sm-4">
				...
				<!-- <div class="col-sm-4">
                 ...
                 <div class="col-sm-12 text-center positionABS" style="margin-bottom:10px;">
                                        ...
                                        <c:if test="${type == 'winnerSelection'}">
                                        	<!-- <button class="btn btn-info winnerSelectionBidder savebtn">Save</button> -->
                                        </c:if>
            ...
            <div>
              	...
              	<div>
             		...
             		<div class="col-sm-12 text-center"><button class="btn btn-default save winnerSubmit savebtn">Submit</button></div>
				</div>
				</div>
			</c:if>
           </div>
