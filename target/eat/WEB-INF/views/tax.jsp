...
<div id="loading-wrapper">
 ...
 <div class="full-container"> 
  ...
  <div id="mobile_second_container" class="right-side col-md-9 no-marg">
          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> TAX Details</a> </h4>
              </div>
	...
	<div class="col-sm-4">
		<div class="styled-input">
			<select id=""  class="taxCategory" required="required">
...
<script src="<%=request.getContextPath()%>/resource/js/bootstrap-datetimepicker.js?appVer=${appVer}"></script>
 <script src="<%=request.getContextPath()%>/resource/js/taxmaster.js?appVer=${appVer}"></script>
