...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/${appMode}/tilescommon/css/mobile.css?appVer=${appVer}"/>
 <%-- <div class="zoom">
  ...
  <div class="detailsheader">
        	<div class="col-sm-3 text-center brdrgt"><label>GTP Parameter Type Reports (<span class="reportCount">0</span>)</label></div>
        </div>
  ...
  <div id="mobile_second_container" class="right-side col-md-9 no-marg">
    <div class="detailsheader">
        	<div class="col-sm-9 text-center"><label>GTP Parameter Type Details</label></div>
        </div>
    <div class="clearfix"></div>
            ...
            <div class="board">
                ...
                <div class="tab-content">
                    ...
                    <div class="col-sm-12 text-right" style="margin-top:7px;">
		                		  <%-- <c:if test="${access.modifyAccess== 'Y'}">
		                		<button type="button" id="addId" onclick="addNewGtpParameterType()" class="btn btn-info bluebutton"><span class="glyphicon glyphicon-plus-sign"></span>Add</button>
		                										  
		                		<button type="button" id="editId" onclick="editPrevGtpParameterType()" class="btn btn-info bluebutton"><span class="glyphicon glyphicon-edit"></span>Edit</button>
		                		</c:if>
		                		<c:if test="${access.deleteAccess== 'Y'}">
		                		<button type="button" id="deleteId"  class="btn btn-info bluebutton" onclick="deleteGtpParameterType()"><span class="glyphicon glyphicon-trash"></span>Delete</button>
