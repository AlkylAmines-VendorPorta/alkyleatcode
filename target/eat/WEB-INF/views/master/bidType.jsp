...
<div class="full-container"> 
  ...
  <div class="detailsheader">
        	<div class="col-sm-3 text-center brdrgt"><label>Bid Type Report (<span class="reportCount">0</span>)</label></div>
        </div>
  ...
  <div id="mobile_second_container" class="right-side col-md-9 no-marg">
    <div class="detailsheader">
        	<div class="col-sm-9 text-center"><label>Bid Type Detail</label></div>
        </div>
    <div class="clearfix"></div>
