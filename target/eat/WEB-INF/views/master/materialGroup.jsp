...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/tilescommon/css/mobile.css"/>
                        ...
                        <div id="mobile_first_container" class="left-side col-md-3 no-marg">
                            <div class="detailsheader">
                                <div class="col-sm-3 text-center brdrgt">
                                    <label>Material Group Report (<span class="reportCount">0</span>)</label>
                                </div>
                            </div>
                    ...
                    <button class="btn btn-default" type="button"><span class="glyphicon glyphicon-search"></span></button>
                               <button class="btn btn-default addMaterialGroup"  onclick="addMaterialGroup(event)" type="button" id="addMaterialGroup">
	...
	<div id="mobile_second_container" class="right-side col-md-9 no-marg">
		<div class="detailsheader">
			<div class="col-sm-9 text-center">
				<label>Material Group Detail</label>
			</div>
		</div>
		<div class="clearfix"></div>
							...
							<div class="tab-pane fade in active" id="home">
								<div class="col-sm-12 text-right">
									<div class="form-group">
										...
										<button type="button" class="btn btn-info bluebutton editMaterialGroup"
											id="editMaterialGroup">
											<span class="glyphicon glyphicon-edit"></span>Edit
										</button>
									</div>
								</div>
								<sf:form id="materialGroupFormId" class="readonly" method="POST"
									autocomplete="off" modelAttribute="MaterialGroup">
									<div class="form-group">
										<div class="col-sm-4">
										...
										class="form-control Id" name="materialGroupId" id="Id">
									</label>
									</div>
									...
									<div class="col-md-12 text-center">
										<button type="button" class="btn btn-info save"
											id="addnewmaterialgroups">Save</button>
										<!-- <button  type="button"  class="btn btn-info save" id="saveeditedmaterialgroup">Save</button> -->
...
<!-- full-container end-->
<script src="<%=request.getContextPath()%>/resource/js/materialGroup.js"></script>
<script
