	...
	<div id="mobile_first_container" class="left-side col-md-3 no-marg">
		<div class="detailsheader">
			<div class="col-sm-3 text-center brdrgt">
				<label>Role Reports (<span class="reportCount">0</span>)
				</label>
			</div>
		</div>
		<div class="input-group">
			...
			<span class="input-group-btn">
				...
				<button class="btn btn-default addnewlist" onclick="addRoleBtn(event)"
					type="button">
					...
					<div class="board">
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="home">
								...
								<div class="clearfix"></div>
								<sf:form id="roleFormId" class="readonly" method="POST"
									autocomplete="off" modelAttribute="Role">
									<div class="form-group">
										<div class="col-sm-4">
										...
										<div class="col-sm-4">
											<div class="styled-input">
												<input type="text" id="Code" name="value" class="Code "
									...
									<label style="display: none;" class="col-md-6 col-xs-12">
										...
										class="form-control Id" name="roleId" id="Id">
									</label>
									...
									<div class="col-md-12 text-center">
										<button type="button" class="btn btn-info save"
											id="addnewroles">Save</button>
										<!--  <button  type="button"  class="btn btn-info save" id="editroles">Save</button> -->
