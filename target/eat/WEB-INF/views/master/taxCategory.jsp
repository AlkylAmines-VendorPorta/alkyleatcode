	...
	<div id="mobile_first_container" class="left-side col-md-3 no-marg">
		<div class="detailsheader">
			<div class="col-sm-3 text-center brdrgt">
				<label>Tax Category Reports (<span class="reportCount">0</span>)
				</label>
			</div>
		</div>
		<div class="input-group">
			...
			<span class="input-group-btn">
				...
				<button class="btn btn-default addnewtaxcat" type="button">
	...
	<div id="mobile_second_container" class="right-side col-md-9 no-marg">
		<div class="detailsheader">
			<div class="col-sm-9 text-center">
				<label>Tax Category Details</label>
			</div>
		</div>
		<div class="clearfix"></div>
					...
					<div class="board">
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="home">
								...
								<sf:form id="taxCatFormId" class="readonly" method="POST"
									autocomplete="off" modelAttribute="TaxCategory">
									<div class="form-group">
										<div class="col-sm-4">
									...
									<label style="display: none;" class="col-md-6 col-xs-12">
										<input style="display: none;" type="text" id="taxCatId"
										class="form-control taxCatId" name="taxCategoryId">
									</label>
									...
									<div class="col-md-12 text-center">
										<div class="col-md-12 text-center">
											<button type="button" class="btn btn-info save"
												id="addnewtaxcat">Save</button>
											<!-- <button  type="button"  class="btn btn-info save" id="editselectedtaxcat">Save</button> -->
...
<!-- full-container end-->
<script src="<%=request.getContextPath()%>/resource/js/taxcategory.js"></script>
<script
