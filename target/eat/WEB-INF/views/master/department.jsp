	...
	<div id="mobile_first_container" class="left-side col-md-3 no-marg">
		<div class="detailsheader">
			<div class="col-sm-3 text-center brdrgt">
				<label>Department View Report (<span class="reportCount">0</span>)
				</label>
			</div>
		</div>
		<div class="input-group">
			...
			<span class="input-group-btn">
				...
				<button class="btn btn-default addnewdepartment" onclick="addDepartment(event)"type="button">
	...
	<div id="mobile_second_container" class="right-side col-md-9 no-marg">
		<div class="detailsheader">
			<div class="col-sm-9 text-center">
				<label>Department View Detail</label>
			</div>
		</div>
		<div class="clearfix"></div>
					...
					<div class="board">
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="home">
								...
								<sf:form id="departmentFormId" class="readonly" method="POST"
									...
									<label style="display: none;" class="col-md-6 col-xs-12">
										...
										class="form-control Id" name="departmentId" id="Id">
									</label>
									...
									<div class="col-md-12 text-center">
										<button type="button" class="btn btn-info save"
											id="savedepartment">Save</button>
										<!--  <button  type="button"  class="btn btn-info save" id="updateediteddepartment">Save</button> -->
...
<!-- full-container end-->
<script src="<%=request.getContextPath()%>/resource/js/department.js?appVer=${appVer}"></script>
