...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/${appMode}/tilescommon/css/mobile.css?appVer=${appVer}">
        ...
        <div class="full-container">
            ...
            <div class="detailsheader">
        		<div class="col-sm-3 text-center brdrgt"><label>Tender Commercial Scrutiny Report (5)</label></div>
       		</div>          
            ...
            <div class="detailsheader toptabbrd">
        		<div class="col-sm-9 text-center"><label>Tender Commercial Scrutiny Details</label></div>
        	 </div>
                <div class="clearfix"></div>
                             ...
                             <div class="posrelative" id="example">                            
                                <div class="demo-section k-content">
                                    <div id="tabstrip2" class="Firsttab">
                                        <ul>
                                            <!-- tabs -->
                                            <li class="k-state-active">Preliminary Commercial Scrutiny</li>
                                            <li>Preliminary Commercial scrutiny</li>
                                            <li>CS Document Details </li>
                                            <li>PC Scrutiny Verify Details</li>
                                            <li>View The CSD</li>
                                        </ul>
                                        ...
                                        <div class="detailscont">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <h4><b>Preliminary Commercial Scrutiny</b></h4>
                                                    <hr>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    <div class="styled-input">
                                                        ...
                                                        <label>Select Tender Code<span class="red">*</span></label>
                                                        <span></span>
                                                    </div>
                                                 </div>
                                                 <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    <div class="styled-input">
                                                        ...
                                                        <label>EMD Status<span class="red">*</span></label>
                                                        <span></span>
                                                    </div>
                                                 </div>
                                                 <div class="col-sm-8">
                                                    <label class="radio-inline top40">
                                                    <input type="radio" value="">In Order to complete PCS following details Required</label>
                                                 </div>
                                               </div>
                                               <div class="form-group">
                                        ...
                                        <div class="detailscont">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <h4><b>Preliminary Commercial scrutiny Verify Details</b></h4>
                                                    <hr>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-3">
                                                    <label class="radio-inline" style="margin:0px;">
                                                        <input type="radio" name="optradio">Recomnded status
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="detailscont">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <h4><b>View The Commercial scrutiny Document</b></h4>
                                                    <hr>
                                                </div>
                                            </div>
                                            <div class="form-group">
