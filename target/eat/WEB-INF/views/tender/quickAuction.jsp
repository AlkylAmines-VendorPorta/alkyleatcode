...
<div class="full-container">
	...
	<div id="mobile_second_container" class="right-side col-md-9 no-marg">
		<div class="detailsheader toptabbrd leftPaneHeader">
			<div class="col-sm-9 text-center">
				<label> Quick Auction</label>
			</div>
		</div>
		<div class="clearfix"></div>
					...
					<div class="posrelative">
						<div class="demo-section k-content">
							<div id="tabstrip" class="Firsttab">
								<ul id="tabUL">
									<!-- tabs -->
									<li id="" onclick="getQuickAuctionBaseInfo();" data-parentTab="" class="k-state-active normalli"><div class="tabcircle"><i class="fa fa-info-circle"></i></div>
										Base Information</li>
