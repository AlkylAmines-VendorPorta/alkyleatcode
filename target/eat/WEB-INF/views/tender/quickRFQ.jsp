...
<script src="<%=request.getContextPath()%>/resources/quickAuction/js/quickAuction.js"></script>
		...
		<!-- <div class="input-group">
			<div class="input-group-btn search-panel">
				<button type="button" class="btn btn-default -toggle"
					...
					<span id="search_concept" class="glyphicon glyphicon-filter"></span> <span class="caret"></span>
				</button>
			...
			<input type="hidden" name="search_param" value="all"
				id="search_param"> <input type="text" id='searchLiteralId'
					...
					<div class="posrelative">
						<div class="demo-section k-content">
							<div id="tabstrip" class="Firsttab">
								<ul id="tabUL">
									<!-- tabs -->
									<li id="tenderBaseInfoTab" onclick="getQuickAuctionBaseInfo();" data-parentTab="" class="k-state-active normalli"><div class="tabcircle"><i class="fa fa-info-circle"></i></div>${documentType}
										Base Info</li>
									...
									<li class="confirmliclick" data-parentTab="tahdrDetailTab"  id="confirmation" ><div class="tabcircle" id="tabcircle"><i class="fa fa-check-circle"></i></div>${documentType}
										Confirmation</li>
								</ul>
									...
									<sf:form class="" id="tahdrForm" action="createTahdr"
										...
										<div id="tenderBaseForm">
											<div class="form-group">
												...
												<div class="col-sm-4">
													<div class="styled-input">
														<input type="text" id="estimatedCost" name="tahdrDetailList[0].estimatedCost"
															class="requiredField"  /> <label>Base Price
															<span class="red">*</span>
														</label> <span></span>
													</div>
												</div>
												<div class="col-sm-4 procurementTender"
													...
													<div class="styled-input">
														<input type="text" id="minBidDifference"
															name="tahdrDetailList[0].minBidDifference" class="requiredField onlyNumber" />
														<label>Bid <c:if
																test="${documentType.equalsIgnoreCase('Quick Reverse Auction')}"> Decrement </c:if>
															<c:if test="${documentType.equalsIgnoreCase('Quick Forword Auction')}"> Increment </c:if>
												...
												<div class="form-group">
													...
													<div class="form-group frgrp auctionDates">
														...
														<div class="input-group date form_datetime" id="auctionStartDates" >
															<input type="text" class="form-control requiredDate" id="auctionStartToDates" name="tahdrDetailList[0].auctionFromDate">
												 ...
												 <div class="col-sm-4 procurementTender setAuctionLater">
													<div class="form-group frgrp auctionDates">
														...
														<div class="input-group date form_datetime" id="auctionEndDates" >
															<input type="text" class="form-control requiredDate" id="auctionEndToDates" name="tahdrDetailList[0].auctionToDate">
															<span class="input-group-addon"><span
																class="glyphicon glyphicon-th"></span></span>
														</div>
														<input type="hidden" id="dtp_input1" value="" /><br />
										...
										<div class="col-sm-12 text-center positionABS"
											...
											<button class="btn btn-info save" onclick="createQuickAuction(event)">Save</button>
