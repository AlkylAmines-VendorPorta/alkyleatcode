...
.k-tabstrip>.k-tabstrip-items .k-state-active {
    ...
    box-shadow: 1px 0px 15px #888888 !important;
}
.nav-pills > li.active > a i, .nav-pills > li.active > a i:hover, .nav-pills > li.active > a i:focus {
    color: #fff;
            ...
            <div class="detailsheader toptabbrd">  
                ...
                <div class="tab-content">
					...
					<ul class="nav nav-pills col-md-12">
					  <li id="priceSubTab" class="active" data-placement="right" data-toggle="tooltip" title="Technical Bid" ><a href="#tab_e" data-toggle="pill"><i class="fa fa-info-circle" aria-hidden="true"></i></a><label>Item Details</label></li>
					  <li id="sectionDocumentSubTab" data-toggle="tooltip" data-placement="right" title="Documents" ><a href="#tab_f" data-toggle="pill"><i class="fa fa-file-text"></i></a><label>GTP Details</label></li>
					  <li id="submitPBTab" data-toggle="tooltip" data-placement="right" title="Confirmation" ><a href="#tab_g" data-toggle="pill"><i class="fa fa-check-circle-o"></i></a><label>PTS Documents</label></li>
					  <li id="submitPBTab2" data-toggle="tooltip" data-placement="right" title="Confirmation" ><a href="#tab_H" data-toggle="pill"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a><label>PTS Verify</label></li>
					</ul>
