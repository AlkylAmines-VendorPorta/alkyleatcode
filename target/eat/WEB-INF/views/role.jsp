...
<div id="loading-wrapper">
  ...
  <!-- Header end -->
  <div class="col-sm-12 text-right"><button type="button" class="btn btn-info newUserBtn"><span class="glyphicon glyphicon-plus-sign"></span>Add New Role</button>
                										  <button type="button" class="btn btn-info editUserBtn"><span class="glyphicon glyphicon-edit"></span>Edit Role</button></div>
          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Role Details</a> </h4>
              </div>
...
<script src="<%=request.getContextPath()%>/resource/js/bootstrap-datetimepicker.js?appVer=${appVer}"></script>
 <script src="<%=request.getContextPath()%>/resource/js/sweetalert2.min.js?appVer=${appVer}"></script>
    <script src="<%=request.getContextPath()%>/resource/js/role.js?appVer=${appVer}"></script>
