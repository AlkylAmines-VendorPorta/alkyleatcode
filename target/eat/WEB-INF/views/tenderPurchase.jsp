                            ...
                            <div class="TypeOfTender"><div class="btn-group btnmrg" data-toggle="buttons">
                                ...
                                <div class="demo-section k-content">
                                    <div id="tabstrip" class="Firsttab">
                                        <ul>
                                            <!-- tabs -->
                                            <li class="k-state-active">Todays Top Tender</li>
                                            <li>Tender Fees Details</li>
                                        </ul>
                                        ...
                                        <div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="styled-input">
                                             	 <div class="col-sm-2">
                                             	 	<a><b><span class="glyphicon glyphicon-plus-sign paddright"></span>Purchase Tender</b></a>
                                             	 </div>
                                             	 <div class="col-sm-2">
                                        ...
                                        <div>
                                            ...
                                            <div class="form-group">                                                
                                                <div class="col-sm-4">
                                                    <div class="styled-input">
                                                        <input type="text" id="" name="" required />
                                                        <label>Tender Number<span class="red">*</span></label>
                                                        <span></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
