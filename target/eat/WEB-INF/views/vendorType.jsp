          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Vendor Type Details</a> </h4>
              </div>
...
<script src="<%=request.getContextPath()%>/resource/js/vendorType.js?appVer=${appVer}"></script>
