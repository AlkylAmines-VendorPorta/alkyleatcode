 ...
 <div class="full-container"> 
  ...
  <div id="mobile_first_container" class="left-side col-md-3 no-marg">
    <div class="input-group">
                ...
                <input type="text" class="search-query form-control" name="x" placeholder="Search term...">
          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Contractor Details</a> </h4>
              </div>
...
<script src="<%=request.getContextPath()%>/resource/js/contractortype.js?appVer=${appVer}"></script>
