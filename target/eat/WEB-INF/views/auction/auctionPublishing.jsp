...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/${appMode}/tilescommon/css//borderTab.css?appVer=${appVer}">
        ...
        <div class="full-container">
        	...
        	<div class="col-sm-3 text-center brdrgt"><label>Auction Publishing Report (5)</label></div>
        </div>
        	...
        	<div class="col-sm-9 text-center"><label>Auction Publishing Details</label></div>
        </div>
                <div class="clearfix"></div>
                        ...
                        <div class="card">
                            ...
                            <div class="demo-section k-content">
                                    <div id="tabstrip" class="Firsttab">
                                        <ul>
                                            <!-- tabs -->
                                            <li class="k-state-active">Auction Publish Notice</li>
                                            <li>Auction Public Notice</li>
                                        </ul>
                                        ...
                                        <div class="detailscont">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <h4><b>Auction Publish Notice</b></h4>
                                                    <hr>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    <button class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>Add Notice</button>
                                                    <button class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span>Edit Notice</button>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                        ...
                                        <div class="detailscont">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <h4><b>Auction Public Notice (To publich New Auction)</b></h4>
                                                    <hr>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="styled-input">
                                                    ...
                                                    <label>Select Auction<span class="red">*</span></label>
                                                    <span></span>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="styled-input">
                                                        <input type="text" id="" name="" required />
                                                        <label>Auction Notice Title<span class="red">*</span></label>
                                                        <span></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="styled-input">
                                                        <input type="text" id="" name="" required />
                                                        <label>Auction Notice Matter<span class="red">*</span></label>
                                                        <span></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Auction Notice Publishing Date<span class="red">*</span></label>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Auction Notice Publishing Time<span class="red">*</span></label>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Auction Sale opening Date<span class="red">*</span></label>
                                                        <div class="input-group date" data-provide="datepicker">
                                                            <input type="text" class="form-control">
                                                            <div class="input-group-addon">
                                                                <span class="glyphicon glyphicon-th"></span>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Auction Sale opening Time<span class="red">*</span></label>
                                                        <div class="input-group bootstrap-timepicker timepicker">
                                                            <input type="text" class="form-control input-small timepicker">
                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                                                        </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Auction Sale closing Date<span class="red">*</span></label>
                                                        <div class="input-group date" data-provide="datepicker">
                                                            <input type="text" class="form-control">
                                                            <div class="input-group-addon">
                                                                <span class="glyphicon glyphicon-th"></span>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Auction Sale closing Time<span class="red">*</span></label>
                                                        <div class="input-group bootstrap-timepicker timepicker">
                                                            <input type="text" class="form-control input-small timepicker">
                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                                                        </div>
