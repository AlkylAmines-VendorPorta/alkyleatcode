...
/*function loadStatisticRightDetail(data){
	debugger;
		$('.leftPaneData li').each(function() {
		...
		if(!$.isEmptyObject(data.objectMap.bidderList)){
			bidderCount(data.objectMap.bidderList);
		}else{
			$("#statisticForm #bidderCount").val("");
			$("#statisticForm #bidderTechnicalCount").html("");
			$("#statisticForm #bidderCommercialCount").html("");
			$("#statisticForm #bidderPriceCount").html("");
			$("#statisticForm #bidderAllCount").html("");
		}
}*/
...
function bidderCount(data){
	...
	if(data.objectMap.result){
		if(tahdrStatus=='PU'){
			...
			$("#statisticForm #bidderTechnicalCountDiv").show();
			$("#statisticForm #bidderPriceCountDiv").show();
			$("#statisticForm #bidderAllCountDiv").show();
			
			$("#statisticForm #bidderCount").html(data.objectMap.bidderCount);
			$("#statisticForm #bidderTechnicalCount").html(data.objectMap.technicalBidderCount);
			$("#statisticForm #bidderPriceCount").html(data.objectMap.priceBidderCount);
			$("#statisticForm #bidderAllCount").html(data.objectMap.allBiddderCount);
		}else{
