...
$(document).ready(function(){
	...
	$('#cancelOrgRegBtnId').click(function(event) {
		...
		editMode=false;
	   	/*activeTabName="";*/
		var regId=$("#udyogRegistrationId").val();
...
/*	    +'	<label class="col-xs-6" id="lblItemList-'+partnerOrgRegistrationId+'" >'+itemList+'</label>'*/
	    ...
	    +'	<label class="col-xs-6" id="isApproved-'+partnerOrgRegistrationId+'" >'+isApproved+'</label>'
	    ...
	    +'	<label class="col-xs-6" id="validityType-'+partnerDirectorDetailsId+'">'+validityType+'</label>'
		+' </div>'
        +' </a>'
        +' </li>';
