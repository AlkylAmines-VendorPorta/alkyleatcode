...
function loadPartnerOrgSigLeftPane(data){
	...
	$.each(data,function(key,value){
		if(!$.isEmptyObject(value.userDetail))
			{
			var userDetailId=value.userDetail.userDetailsId==null?'':value.userDetail.userDetailsId;
				...
				var designationId  = value.userDetail.designation==null?'':value.userDetail.designation.designationId==null?'':value.userDetail.designation.designationId;
				var dob=value.userDetail.dob==null?'':formatDate(value.userDetail.dob);
				var gender=value.userDetail.gender==null?'':value.userDetail.gender;
				...
				if(!$.isEmptyObject(value.location))
				{
					...
					var districtId  = value.location.district==null?'':value.location.district.districtId==null?'':value.location.district.districtId;
					var countryId  = value.location.country==null?'':value.location.country.countryId==null?'':value.location.country.countryId;
					var regionId  = value.location.region==null?'':value.location.region.regionId==null?'':value.location.region.regionId;
...
function loadPartnerOrgSigRightPane(data){
	...
	setChildLoadFlag(true);
	/*activeTabName="";*/
	if(!$.isEmptyObject(data.userDetail))
	{
...
function loadRecentSignatory(data)
{
	...
	var otherDesignation=data.otherDesignation==null?'':data.otherDesignation;
	$("#partnerSignatoryForm #partnerSignatoryId").val(partnerSignatoryId);
	$("#partnerSignatoryForm #locationId").val(data.location.locationId);
	$('#partnerSignatoryForm #userDetailId').val(data.userDetail.userDetailsId);
