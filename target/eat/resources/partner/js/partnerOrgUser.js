  ...
  if(data.response.hasError==false)
   {
	...
	var userFlag=true;
	var leftPanelHtml='';
	var partnerOrgUserId=data.partnerOrgUserId;
	var currentOrgUserId=$('ul.leftPaneData').find('li.active').attr('id');
...
function appendOrgUserData(value,active)
{
	...
	if(!$.isEmptyObject(value.userDetail)){
     var firstName = value.userDetail.firstName==null?'':value.userDetail.firstName;
     var middleName  = value.userDetail.middleName==null?'':value.userDetail.middleName;
     var lastName  = value.userDetail.lastName==null?'':value.userDetail.lastName;
     ...
     var title  = value.userDetail.title==null?'':value.userDetail.title;
     ...
     var designation  = (value.userDetail.designation==null ||value.userDetail.designation.designationId==null)?'':value.userDetail.designation.designationId;
     var address1  = (value.userDetail.location==null || value.userDetail.location.address1==null)?'':value.userDetail.location.address1;
     var district  = (value.userDetail.location==null || value.userDetail.location.district.districtId==null)?'':value.userDetail.location.district.districtId;
     var city  =  (value.userDetail.location==null || value.userDetail.location.city==null)?'':value.userDetail.location.city;
     var country  = (value.userDetail.location==null || value.userDetail.location.country.countryId==null)?'':value.userDetail.location.country.countryId;
     var region  = (value.userDetail.location==null ||value.userDetail.location.region.regionId==null)?'':value.userDetail.location.region.regionId;
     var postal  = (value.userDetail.location==null ||value.userDetail.location.postal==null)?'':value.userDetail.location.postal;
     var locationId=(value.userDetail.location==null ||value.userDetail.location.locationId==null)?'':value.userDetail.location.locationId;
     var userDetailsId=(value.userDetail==null ||value.userDetail.userDetailsId==null)?'':value.userDetail.userDetailsId;
