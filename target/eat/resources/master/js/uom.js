...
$(document).ready(function(){ 
	...
	$("#savenewuom").click(function(){
		$("#editselecteduom").hide();
		submitIt("uommaster","addNewUom", "getResponseDto");
	});
	$("#deluom").click(function(){
		
		 $(".Id").attr('name', 'uomId');
		 submitIt("uommaster","deleteUom", "getResponseDelete");
		
		
	});
	 $("#editmaterialsubgroup").click(function(){
		  $(".Id").attr('name', 'uomId');
		  $("#editselecteduom").show();
		  $("#savenewuom").hide();
		
		});
	
   $("#editselecteduom").click(function(){
	   submitIt("uommaster","upadateUom", "getResponseUpdate");
