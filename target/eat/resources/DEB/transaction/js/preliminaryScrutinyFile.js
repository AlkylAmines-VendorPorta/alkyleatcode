...
function removeScrutinyFileData(){
	$('#gennerateTechnicalScrutinyDoc #scrutinyFileId').val('');
	$('#gennerateTechnicalScrutinyDoc #a_techFileResponse').html('');
	$('#gennerateTechnicalScrutinyDoc #a_techFileResponse').removeAttr('href');
	$('#gennerateCommercialScrutinyDoc #scrutinyFileId').val('');
	$('#gennerateCommercialScrutinyDoc #a_commFileResponse').html('');
	$('#gennerateCommercialScrutinyDoc #a_commFileResponse').removeAttr('href');
	$('#gennerateCommercialScrutinyDoc #deleteCommercialAttachmentId').attr('disabled','disabled');
	$('#gennerateTechnicalScrutinyDoc #deleteTechnicalAttachmentId').attr('disabled','disabled');
