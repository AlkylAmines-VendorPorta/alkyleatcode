	...
	if(!$.isEmptyObject(data)){
			...
			if(!$.isEmptyObject(data.bidderGtp)){
					...
					$("#PTSGtpForm #bidderGtpResp").html(html);
	    			 ...
	    			 deviationStatusChange("#PTSGtpForm #deviationTypeCode","#PTSGtpForm");
			    			 ...
			    			 var comment=data.deviationComment==null?'': data.deviationComment;
				    			...
				    			if(bidsection=='TS'){
						    			...
						    			$("#PTSDocForm #PTSdownloadLinkId").html(attachmentName);
						    			 ...
						    			 deviationStatusChange("#PTSDocForm #deviationTypeCode","#PTSDocForm");
				    				...
				    				$("#gennerateCommercialScrutinyDoc #itemScrutinyId").val(itemScrutinyId);
						    			...
						    			$("#PCSDocForm #PCSdownloadLinkId").html(attachmentName);
						    			 ...
						    			 deviationStatusChange("#PCSDocForm #deviationTypeCode","#PCSDocForm");
...
function deviationStatusChange(el,formId){
	var status=$(el).val();
	if(status=='N'){
			...
			$("#PCSDocForm #deviationType").removeClass('requiredField');
			$("#PCSDocForm #deviationType").removeClass('errorinput');
			$(formId+' #comment').removeClass('requiredField');
			$(formId+' #comment').removeClass('errorinput');
			$(formId+' #labelId > span.red').html('');
			 /* $('#'+formId+' #comment').removeClass('red');*/
		}
	else if(status=='Y'){
			...
			$("#PCSDocForm #deviationType").addClass('requiredField');
		
			$(formId+' #comment').addClass('requiredField');
...
function loadScrutinyPointRightPane(data){
	...
	if(!$.isEmptyObject(data)){
		 ...
		 deviationStatusChange("#PCSSPForm #deviationTypeCode","#PCSSPForm");
