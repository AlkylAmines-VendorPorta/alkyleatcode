...
function onClickPriceBid(){
	debugger;
		partsArray=[];
		$(".priceBidId").val('');
		if(selectedTender.tahdr.tahdrTypeCode=='PT' || selectedTender.tahdr.tahdrTypeCode=='QRFQ' || selectedTender.tahdr.tahdrTypeCode=='RFQ'){
			if(selectedItemBid[0].tahdrMaterial.materialTypeCode=='bom'){
				$("#partsTab").show();
				$("#priceSubTab").show();
				getPriceBidForParts();
			}else{
