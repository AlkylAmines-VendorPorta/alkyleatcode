...
function loadPartnerManufacturerOrgRightPane(data) {
	...
	loadStateByCountry('manufacturerOrgCountry','manufacturerOrgForm','manufacturerOrgRegion');
	$("#manufacturerOrgForm #manufacturerOrgRegion").val(region);
	loadDistrictByState('manufacturerOrgRegion','manufacturerOrgForm','manufacturerOrgDistrict');
