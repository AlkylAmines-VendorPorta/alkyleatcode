...
{ 
	...
	if(!$.isEmptyObject(value.attachment)){
    	 ...
    	 var description = value.tahdr==null?'':value.tahdr.title==null?'':value.tahdr.title;
    	 var matter = value.description==null?'':value.description;
    	 
    	 modalTableData +='<tr>'  
    		+'<td title="'+count+'">'+count+' </td>'
         	+'<td title="'+tahdrData+'">'+tahdrData+' </td>'
         	+'<td title="'+description+'">'+description+'</td>'
         	+'<td title="'+matter+'">'+matter+'</td>'
         	+'<td title="'+formatDate(pdate)+'">'+formatDate(pdate)+'</td>'
