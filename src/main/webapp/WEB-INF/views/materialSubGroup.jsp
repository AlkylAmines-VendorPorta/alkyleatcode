          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Material Sub Group Details</a> </h4>
              </div>
              ...
              <div class="col-sm-4">
                    <div class="styled-input">
                        <select id=""  class="matGroup" required="required">
