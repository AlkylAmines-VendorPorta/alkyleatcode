...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/${appMode}/tilescommon/css//borderTab.css?appVer=${appVer}">
        ...
        <div class="full-container">
            ...
            <div class="detailsheader">
        		<div class="col-sm-3 text-center brdrgt"><label>Auction Commercial Scrutiny Report (5)</label></div>
       		</div>          
            ...
            <div class="detailsheader toptabbrd">
        		<div class="col-sm-9 text-center"><label>Auction Commercial Scrutiny Details</label></div>
        	 </div>
                <div class="clearfix"></div>
