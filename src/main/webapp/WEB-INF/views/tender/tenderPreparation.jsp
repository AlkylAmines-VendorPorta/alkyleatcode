...
<div class="full-container">
	...
	<div id="mobile_first_container" class="left-side col-md-3 no-marg">
		...
		<c:if test="${documentType.equalsIgnoreCase('RFQ')}">
			<input type="radio" name="tenderTypeCodeToggle" checked
					...
					<div class="posrelative">
						<div class="demo-section k-content">
							<div id="tabstrip" class="Firsttab">
								<ul id="tabUL">
									<!-- tabs -->
									<li id="tenderBaseInfoTab" data-parentTab="" class="k-state-active normalli"><div class="tabcircle"><i class="fa fa-info-circle"></i></div>${documentType}
										Base Info</li>
									<li class="CreatePrivateAuctiontab normalli" data-parentTab="tenderBaseInfoTab" style="display: none;"><div class="tabcircle"><i class="fa fa-address-card"></i></div>Vendor
										Selection</li>
									<li class="normalli readonly" data-parentTab="tenderBaseInfoTab" id="tahdrDetailTab"><div class="tabcircle"><i class="fa fa-calendar"></i></div>${documentType}
										Details</li>
									...
									<li class="normalli readonly tenderDocsClass" data-parentTab="tahdrDetailTab" id="tenderDocTab"><div class="tabcircle"><i class="fa fa-file"></i></div>${documentType}
										Docs</li>
									<li class="normalli readonly" data-parentTab="tahdrDetailTab" id="getTahdrMaterialList"
										...
										${documentType}</li>
									<li class="normalli readonly reqDocsClass " data-parentTab="tahdrDetailTab" id="sectionDocTab"><div class="tabcircle"><i class="fa fa-file-text-o"></i></div>Required Docs
										</li>
									<li class="confirmliclick readonly" data-parentTab="tahdrDetailTab"  id="confirmation" ><div class="tabcircle" id="tabcircle"><i class="fa fa-check-circle"></i></div>${documentType}
										Confirmation</li>
								</ul>
										...
										<div class="form-group">
											...
											<div class="col-sm-6 text-right">
												<button type="button" onclick="addNewTahdr(event)"
													...
													<span class="glyphicon glyphicon-plus-sign"></span>Create New ${documentType}
												</button>
												...
												<button class="btn btn-default editTahdr"
													...
													<span class="glyphicon glyphicon-pencil"></span>Edit ${documentType}
												</button>
												...
												<div class="col-sm-4">
													<div class="styled-input">
														<input type="text" id="estimatedCost" name="estimatedCost"
															...
															onkeyup="calculateEMDFeeOnType()" /> <label>Estimated
