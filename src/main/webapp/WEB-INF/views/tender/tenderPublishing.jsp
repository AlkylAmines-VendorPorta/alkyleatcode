...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/${appMode}/tilescommon/css/mobile.css?appVer=${appVer}">
        ...
        <div class="full-container">
        	...
        	<div class="col-sm-3 text-center brdrgt"><label>Tender Publishing Report (5)</label></div>
        </div>
                ...
                <ul id="leftPaneData" class="nav nav-tabs tabs-left example">
                    <li class="active">
        	...
        	<div class="col-sm-9 text-center"><label>Tender Publishing Details</label></div>
        </div>
                <div class="clearfix"></div>
                        ...
                        <div class="card">
                            ...
                            <div class="demo-section k-content">
                                    <div id="tabstrip" class="Firsttab">
                                        <ul>
                                            <!-- tabs -->
                                            <li class="k-state-active">Tender Publish Notice</li>
                                        ...
                                        <div class="detailscont">
  							 				<div class="col-md-12">
                                <label class="col-xs-6"> Tender Name :</label>
                            	<label class="col-xs-6 ">Tender Number :</label>
                            </div>	
                            <div class="col-md-12">
                           		<label class="col-xs-6">Vendor Type :</label>
                            	<label class="col-xs-6 ">Description :</label>
                            </div>
    									</div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <h4><b>Tender Publish Notice</b></h4>
                                                    <hr>
                                                </div>
                                            </div>
                                            <div class="form-group">
