...
<jsp:include page="dashbordSideBar.jsp" />
        ...
        <div class="full-container">
            ...
            <div id="mobile_first_container" class="left-side col-md-3 no-marg">
                ...
                <div class="input-group">
                   ...
                   <!--  onkeyup="searchuom()" -->
                    <input type="text" class="search-query form-control" name="x" id="searchlitralid" placeholder="Search term...">
                    ...
                    <input style="display:none;" type="text" class="form-control Id">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="" class=" isActive" disabled="disabled"> Active </label>
                                            </div>
                                            <div class="clearfix"></div>
   ...
   <%--  <script src="<%=request.getContextPath()%>/resource/js/less.min.js?appVer=${appVer}"></script> --%>
    ...
    <script src="<%=request.getContextPath()%>/resource/js/uom.js?appVer=${appVer}"></script>
    <script>
