    ...
    <div class="full-container animated slideInLeft">
        ...
        <div id="ProductDetailsTiles" class="container top20">
            ...
            <div id="AuctionDetailsTiles">
                <a href="Addpr.html" id="AddPR" class="col-md-3">
                    <div class="tiles text-center">
                        <i class="fa fa-plus pull-left font36"></i>
                        <h4 class="tiles-heading">Add PR</h4>
                        <h6 class="tiles-count">1 Records</h6>
                        <div class="clearfix"></div>
                    </div>
                </a>

                <a href="ConvertPRIntoAuction.HTML" id="" class="col-md-3">
                    <div class="tiles text-center">
                        <i class="fa fa-plus pull-left font36"></i>
                        <h4 class="tiles-heading">Convert PR To Auction</h4>
                        <h6 class="tiles-count">0 Records</h6>
                        <div class="clearfix"></div>
                    </div>
                </a>
                <a href="addauction" id="" class="col-md-3">
                    <div class="tiles text-center">
                        <i class="fa fa-plus pull-left font36"></i>
                        <h4 class="tiles-heading">Add Batch/Auction</h4>
                        <h6 class="tiles-count">0 Records</h6>
                        <div class="clearfix"></div>
                    </div>
                </a>
                <a href="ProposalStage.html" id="" class="col-md-3">
                    <div class="tiles text-center">
                        <i class="fa fa-plus pull-left font36"></i>
                        <h4 class="tiles-heading">Proposal Stage</h4>
                        <h6 class="tiles-count">0 Records</h6>
                        <div class="clearfix"></div>
                    </div>
                </a>
                <a href="LiveAuction.html" id="" class="col-md-3">
                    <div class="tiles text-center">
                        <i class="fa fa-plus pull-left font36"></i>
                        <h4 class="tiles-heading">Live Auction</h4>
                        <h6 class="tiles-count">0 Records</h6>
                        <div class="clearfix"></div>
                    </div>
                </a>
                <a href="SelectAuctionWinner.html" id="" class="col-md-3">
                    <div class="tiles text-center">
                        <i class="fa fa-plus pull-left font36"></i>
                        <h4 class="tiles-heading">Select Auction Winner</h4>
                        <h6 class="tiles-count">0 Records</h6>
                        <div class="clearfix"></div>
                    </div>
                </a>
                <a href="AuctionReport.html" id="" class="col-md-3">
                    <div class="tiles text-center">
                        <i class="fa fa-plus pull-left font36"></i>
                        <h4 class="tiles-heading">Auction Report</h4>
                        <h6 class="tiles-count">0 Records</h6>
                        <div class="clearfix"></div>
                    </div>
                </a>
                <a href="RateAuctionWinner.html" id="" class="col-md-3">
                    <div class="tiles text-center">
                        <i class="fa fa-plus pull-left font36"></i>
                        <h4 class="tiles-heading">Rate Auction Winner</h4>
                        <h6 class="tiles-count">0 Records</h6>
                        <div class="clearfix"></div>
                    </div>
                </a>
                <a href="BenefitReport.html" id="" class="col-md-3">
                    <div class="tiles text-center">
                        <i class="fa fa-plus pull-left font36"></i>
                        <h4 class="tiles-heading">Benefit Report</h4>
                        <h6 class="tiles-count">0 Records</h6>
                        <div class="clearfix"></div>
                    </div>
                </a>
