          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Material Details</a> </h4>
              </div>
              <div id="collapse1" class="panel-collapse collapse in">
               ...
               <div class="form-group">  
                <div class="col-sm-4">
                    <div class="styled-input">
                        <input type="text" id=""  class="HSNCode" required="required" />
                        <label>HSN Code<span class="red">*</span></label>
                        <span></span>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="styled-input">
                        <select id="matGroup"  class="matGroup" required="required">
                ...
                <div class="col-sm-4">
                    <div class="styled-input">
                        <select type="text" id="matSubGroup"  class="matSubGroup" required="required">
                        	<!-- <option value="" disabled selected>Select Material SubGroup</option> -->
							<c:forEach var="materialSubGroup" items="${materialSubGroup}">
								<option value="${materialSubGroup.materialSubGroupId}">${materialSubGroup.name}</option>
							</c:forEach>
                        </select>
                        <label>Material Sub-Group<span class="red">*</span></label>
                        <span></span>
                    </div>
                </div>
               </div>
               <div class="form-group">
                <div class="col-sm-4">
                    <div class="styled-input">
                        <select type="text" id="uom"  class="uom" required="required">
                        	<!-- <option value="" disabled selected>Select Material SubGroup</option> -->
                ...
                <div class="col-sm-4">
                    <div class="styled-input">
                        <input type="text" id=""  class="ItemTrade" required="required" />
                        <label>Item Trade<span class="red">*</span></label>
                        <span></span>
                    </div>
                </div>
              <div class="col-sm-4">
                  ...
                  <div class="col-md-12 col-xs-12">
                    <label class="checkbox-inline">
                      <input type="checkbox" value="" class="TestReport"  disabled="disabled">
                      Test Report </label>
                  </div>
                  <div class="col-md-12 col-xs-12">
                    <label class="checkbox-inline">
                      <input type="checkbox" value="" class="SSI"  disabled="disabled">
                      SSI </label>
                  </div>
                  <div class="col-md-12 col-xs-12">
                    <label class="checkbox-inline">
                      <input type="checkbox" value="" class="NSIC"  disabled="disabled">
                      NSIC </label>
                  </div>
                  <div class="col-md-12 col-xs-12">
                    <label class="checkbox-inline">
                      <input type="checkbox" value="" class="PropReport"  disabled="disabled">
                      Prop Report </label>
                  </div>
                   </div>
                    </div>
                  <div class="clearfix"></div>
                    <div class="col-md-12 text-center">
                     <!--  <button type="button"  class="btn btn-info saveBtn">Save</button>
                      <button type="button"  class="btn btn-info CamcleBtn">Cancel</button> -->
                    </div>
                 </form>
                </div>
              </div>
