        ...
        <div class="full-container">
            ...
            <div class="detailsheader leftPaneHeader">
				...
				<c:if test="${documentType.equalsIgnoreCase('Request For Proposal')}">
					<input type="radio" name="toggleTenderType" checked style="display:none;" value="RFQ" >
				</c:if>
					...
					<div class="tab-pane active" id="tab_h">
				             <div class="form-group">
				             	<div class="col-sm-12">
				                	...
				                	<h4 id="calculationDetailsH4" style="display : none ;"><b><span style="color:green;"> <label id="calculationDetails">TEST</label></span></b></h4>
				                    <hr>
				                </div>
				             </div>
				             <div class="clearfix"></div>
				             <div class="form-group">
                            <label class="col-sm-8"><span style="color:red;">Note : </span> Any changes made in Delivery Details will change bid submission status to drafted </label>
                            <div class="col-sm-4">
					                   <button id="showInfo" class="btn btn-default orange pull-right" >
					                   <span class="glyphicon glyphicon-info-sign"></span>Need Help?</button>
					                </div>
                            </div>
						...
						<div class="tab-pane active" id="tab_e">
                           ...
                           <div class="clearfix"></div>
							...
							<sf:form action="savePriceBid" id="savePriceBidForm" modelAttribute="itemBid">                                      
                                ...
                                <div class="col-sm-3">
                                    <div class="styled-input">
                                        <input type="text" class="onlyNumber requiredField readonly" onchange="onChangeOfferedQuantity(this)" id="offeredQuantity" name="priceBid.offeredQuantity">
...
<p>Dear Sir/Madam,</p>
<br>
<p>We hereby offer to carry out the work of design, manufacture, testing and supply of material/equipments as detailed in your  specification and in accordance with the terms and conditions thereof.</p>
<br>
<p>We have carefully perused the above  specification connected with the work and agree to abide by the same.</p>
<br>

<p>I/We agree to supply the materials at the rates herein by me/us subject to the conditions .</p> 
<br>
<p>I/We hereby agree to keep this offer open upto the date as indicated in details & clause of validity shall be bound by communication of acceptance dispatched within the validity period.</p>
<br>
<p>We further agree to execute the contract if awarded referred to in specification as per the terms and conditions
specified therein.</p>
<br>
<b>
...
<script src="<%=request.getContextPath()%>/resources/QuickRFQ/quickRfqProposalSubmission.js"></script>
