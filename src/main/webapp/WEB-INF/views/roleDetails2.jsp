...
<head>
  ...
  <style>.form-group input[type="checkbox"] {
    display: none;
}
...
.btn-group{margin-bottom:7px; margin-right:2px;}
.btn-group>.btn-default{padding:0px;}
.btn-success span.glyphicon {
  opacity: 1; 
}
.btn-group .btn-primary span.glyphicon{opacity: 1;}
.btn-group .btn-primary{padding:5px;}
.btn-success {
    border-color: #3d863d;
}
          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Select Role Details</a> </h4>
              </div>
              <div id="collapse1" class="panel-collapse collapse in">
                <div class="panel-body">
                <div class="col-xs-12 col-sm-12">        
        			<div class="form-group">
          			  <input type="checkbox" id="Dashboard" autocomplete="off" />
            			<div class="btn-group">
             			<label for="Dashboard" class="btn btn-success">
            		...
            		<input type="checkbox"  id="Master" onchange="masterShow()" autocomplete="off" />
            			<div class="btn-group">
             			<label for="Master" class="btn btn-success">
                  		   <span class="glyphicon glyphicon-ok"></span>
                   		   <span> </span>
                		</label>
                		<label for="Master" class="btn btn-success ">
            		...
            		<input type="checkbox"  id="Tenders" onchange="tenderShow()" autocomplete="off" />
            			<div class="btn-group">
             			<label for="Master" class="btn btn-success">
                  		   <span class="glyphicon glyphicon-ok"></span>
                   		   <span> </span>
                		</label>
                		<label for="Tenders" class="btn btn-success ">
                  	    Tenders
               		   </label>
            		</div>
      			  </div> 
