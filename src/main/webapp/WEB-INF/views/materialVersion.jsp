          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Material Version Details</a> </h4>
              </div>
...
<script src="<%=request.getContextPath()%>/resource/js/sweetalert2.min.js?appVer=${appVer}"></script>
    <script src="<%=request.getContextPath()%>/resource/js/materialVersion.js?appVer=${appVer}"></script>
