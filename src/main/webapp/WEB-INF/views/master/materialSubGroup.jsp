	...
	<div id="mobile_first_container" class="left-side col-md-3 no-marg">
		<div class="detailsheader">
			<div class="col-sm-3 text-center brdrgt">
				<label>Material Sub-Group Report (<span class="reportCount">0</span>)
				</label>
			</div>
		</div>
		<div class="input-group">
			...
			<span class="input-group-btn">
				...
				<button class="btn btn-default addmaterialsubgroup"
					onclick="addMaterialSubGroup(event)" type="button">
	...
	<div id="mobile_second_container" class="right-side col-md-9 no-marg">
		<div class="detailsheader">
			<div class="col-sm-9 text-center">
				<label>Material Sub-Group Detail</label>
			</div>
		</div>
		<div class="clearfix"></div>
					...
					<div class="board">
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="home">
								...
								<sf:form id="materialSubGroupFormId" class="readonly"
									method="POST" autocomplete="off"
									modelAttribute="MaterialSubGroup">
									<div class="form-group">
										<div class="col-sm-4">
										...
										<div class="col-sm-4">
											<div class="styled-input">
												<input type="text" id="Description" name="description"
													class="Description" required="required" /> <label>Description</label>
												<span></span>
											</div>
										</div>
										<div class="col-sm-4">
										...
										<div class="col-md-12 text-center">
											<button type="button" class="btn btn-info save"
												id="addnewmaterialsubgroup">Save</button>
											<!--  <button  type="button"  class="btn btn-info save" id="editselectedmaterialsubgroups">Save</button> -->
...
<!-- full-container end-->
<script src="<%=request.getContextPath()%>/resource/js/materialSubGroup.js?appVer=${appVer}"></script>
