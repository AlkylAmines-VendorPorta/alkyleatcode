...
<div class="full-container"> 
  ...
  <div class="detailsheader">
        	<div class="col-sm-3 text-center brdrgt"><label>IS-STD Reports (<span class="reportCount">0</span>)</label></div>
        </div>
  ...
  <div id="mobile_second_container" class="right-side col-md-9 no-marg">
    <div class="detailsheader">
        	<div class="col-sm-9 text-center"><label>IS-STD Details</label></div>
        </div>
    <div class="clearfix"></div>
	...
	<div class="col-sm-4">
		<div class="styled-input slate">
			<select id=""  class="Material" required="required">
...
<!-- full-container end-->
 <script src="<%=request.getContextPath()%>/resource/js/isstandard.js?appVer=${appVer}"></script>
