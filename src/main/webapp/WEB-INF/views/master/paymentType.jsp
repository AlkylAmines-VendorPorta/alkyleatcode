                        ...
                        <div id="mobile_first_container" class="left-side col-md-3 no-marg">
                            <div class="detailsheader">
                                <div class="col-sm-3 text-center brdrgt">
                                    <label>Payment Type Report (<span class="reportCount">0</span>)</label>
                                </div>
                            </div>
                                                    ...
                                                    <form class="readonly">
                                                        ...
                                                        <div class="col-md-4 col-xs-12">
                                                            <label class="checkbox-inline">
                                                                <input type="checkbox" value="" class="periodType" > Period Type </label>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 col-xs-12">
                                                            <label class="checkbox-inline">
                                                                <input type="checkbox" value="" class="refundable" > Refundable </label>
                                                        </div>
                                                    </form>
                                                </div>
                                                <div class="clearfix"></div>
