	...
	<div id="mobile_first_container" class="left-side col-md-3 no-marg">
		<div class="detailsheader">
			<div class="col-sm-3 text-center brdrgt">
				<label>Designation Reports (<span class="reportCount">0</span>)
				</label>
			</div>
		</div>
		<div class="input-group">
			...
			<span class="input-group-btn">
				...
				<button class="btn btn-default addnewdesignation" onclick="addDesignation(event)" type="button">
					...
					<div class="board">
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="home">
								...
								<sf:form id="designationFormId" class="readonly" method="POST"
									autocomplete="off" modelAttribute="Designation">
									<div class="form-group">
										<div class="col-sm-4">
									...
									<label style="display: none;" class="col-md-6 col-xs-12">
										...
										class="form-control Id" name="designationId" id="Id">
									</label>
						  ...
						  Active </label> -->
									...
									<div class="col-md-12 text-center">
										<button type="button" class="btn btn-info save"
											id="savedesignation">Save</button>
										<!--  <button  type="button"  class="btn btn-info save" id="updateediteddesignation">Save</button> -->
...
<!-- full-container end-->
<script src="<%=request.getContextPath()%>/resource/js/designation.js?appVer=${appVer}"></script>
