...
<div class="full-container"> 
  ...
  <div class="detailsheader">
        	<div class="col-sm-3 text-center brdrgt"><label>Holder Type Reports (<span class="reportCount">0</span>)</label></div>
        </div>
  ...
  <div id="mobile_second_container" class="right-side col-md-9 no-marg">
    <div class="detailsheader">
        	<div class="col-sm-9 text-center"><label>Holder Type Details</label></div>
        </div>
    <div class="clearfix"></div>
...
<!-- full-container end-->
<script src="<%=request.getContextPath()%>/resource/js/holdertype.js?appVer=${appVer}"></script>
