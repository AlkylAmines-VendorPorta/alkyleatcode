          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Material Specification Details</a> </h4>
              </div>
              <div id="collapse1" class="panel-collapse collapse in">
                ...
                <div class="col-sm-4">
                    <div class="styled-input">
                        <select type="text" id=""  class="Material" required="required">
                   ...
                   <div class="col-sm-4">
                    <div class="styled-input">
                        <input type="text" id=""  class="Specification" required="required" />
                ...
                <div class="col-sm-4">
                    <div class="styled-input">
                        <input type="text" id=""  class="Quantity" required="required" />
