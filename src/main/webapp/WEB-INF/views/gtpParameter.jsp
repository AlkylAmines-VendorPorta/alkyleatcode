...
<div id="loading-wrapper">
 ...
 <div class="full-container"> 
  ...
  <div id="mobile_second_container" class="right-side col-md-9 no-marg">
          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> GTP Parameter Details</a> </h4>
              </div>
	...
	<div class="col-sm-4">
		<div class="styled-input">
			<select id=""  name="gtpParameterType.gtpParameterTypeId" class="gtpParameterType" required="required" >
			<option value="0" disabled selected>Select GTP ParameterType</option>
			...
			<span></span>
                 ...
                 <%--   <label class="col-md-6 col-xs-12">GTP Parameter Type<span class="red">*</span>
                    <select class="form-control gtpParameterType" name="gtpParameterType.gtpParameterTypeId" disabled="disabled">
                    <option value="0" disabled selected>Select GTP ParameterType</option>
															<c:forEach var="gtpParameterType" items="${gtpParameterType}">
																<option value="${gtpParameterType.gtpParameterTypeId}">${gtpParameterType.name}</option>
															</c:forEach>
                   ...
                   <label style="display:none;" class="col-md-6 col-xs-12">
                    <input style="display:none;" type="text" class="form-control Id" name="gtpParameterId">
                  </label>            
