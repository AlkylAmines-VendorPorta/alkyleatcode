	 ...
	 if(active)
		...
		var isCEApproved=value.isCEApproved==null?'':value.isCEApproved;
		 ...
		 leftPanelHtml = leftPanelHtml +' <a href="#Master" data-toggle="tab">'
			...
			+'	<label class="col-xs-6" id="labelMobileNo-'+partnerItemManufacturerId+'">'+mobileNo+'</label>'
		    +'	<label class="col-xs-6" id="labelEmail-'+partnerItemManufacturerId+'">'+email+'</label>'
		    +'	<label class="col-xs-6" id="labelTelephone1-'+partnerItemManufacturerId+'">'+telephone1+'</label>'
		    +'	<label class="col-xs-6" id="labelpartnerItemManufacturerId-'+partnerItemManufacturerId+'">'+partnerItemManufacturerId+'</label>'
		    +'	<label class="col-xs-6" id="labelTelephone2-'+partnerItemManufacturerId+'">'+telephone2+'</label>'
		    +'	<label class="col-xs-6" id="labelFax1-'+partnerItemManufacturerId+'">'+fax1+'</label>'
		    +'	<label class="col-xs-6" id="labelFax2-'+partnerItemManufacturerId+'">'+fax2+'</label>'
		    +'	<label class="col-xs-6" id="labelLocationId-'+partnerItemManufacturerId+'">'+locationId+'</label>'
		    +'	<label class="col-xs-6" id="labelAddress1-'+partnerItemManufacturerId+'">'+address1+'</label>'
		    +'	<label class="col-xs-6" id="labelDistrict-'+partnerItemManufacturerId+'">'+district+'</label>'
		    +'	<label class="col-xs-6" id="labelCity-'+partnerItemManufacturerId+'">'+city+'</label>'
		    +'	<label class="col-xs-6" id="labelCountry-'+partnerItemManufacturerId+'">'+country+'</label>'
		    +'	<label class="col-xs-6" id="labelRegion-'+partnerItemManufacturerId+'">'+region+'</label>'
		    +'	<label class="col-xs-6" id="labelPostal-'+partnerItemManufacturerId+'">'+postal+'</label>'
		    +'	<label class="col-xs-6" id="remark-'+partnerItemManufacturerId+'">'+remark+'</label>'
		    +'	<label class="col-xs-6" id="isApproved-'+partnerItemManufacturerId+'">'+isApproved+'</label>'
		    +'	<label class="col-xs-6" id="eeComment-'+partnerItemManufacturerId+'">'+eeComment+'</label>'
		    +'	<label class="col-xs-6" id="ceComment-'+partnerItemManufacturerId+'">'+ceComment+'</label>'
		    +'	<label class="col-xs-6" id="isEEApproved-'+partnerItemManufacturerId+'">'+isEEApproved+'</label>'
		    +'	<label class="col-xs-6" id="isCEApproved-'+partnerItemManufacturerId+'">'+isCEApproved+'</label>'
		    +' </div>'
	        +' </a>'
	        +' </li>';
...
debugger;
	...
	var country =   (data.location==null||data.location.country.countryId==null)?'':data.location.country.countryId;
	var region =    (data.location==null||data.location.region.regionId==null)?'':data.location.region.regionId;
