...
$(document).ready(function(){
	...
	$("input[name='toggleTenderType']").change(function(){
		...
		if(responseData.objectMap.status==true){
		if(responseData.data.length==0){
	    	...
	    	var tahdrType=responseData.objectMap.tenderType==null?'':responseData.objectMap.tenderType;
	...
	$.ajax({
        ...
        success: function (data) {
        	...
        	else
        	{
        		...
        		tahdrList=data.objectMap.tenderList;
	        	populatePaymentType(paymentType);
	        	appendList(data.objectMap.tenderList);
	        	$.each(tahdrList,function(key,value){
...
function renderList(){ 
	urlName='getTenderListForPurchase';
	paramName=$("#documentType").val();
	...
	$.ajax({
        ...
        success: function (data) {
        	...
        	else
        	{
        		debugger;
	        	var activeStatus='';
	        	var tahdrDetail=data.objectMap.tahdrDetail;
				var paymentDetail=data.objectMap.paymentDetail;
