 ...
 */
@Repository
public class CompanyTypeDaoImpl extends AbstractJpaDAO<CompanyType, CompanyTypeDto> implements CompanyTypeDao{

private static final String ENTITY_NAME="M_COMPANYTYPE";
	
	@PostConstruct
	private void init() {
		setClazz(CompanyType.class, CompanyTypeDto.class);
	}
	...
	public List<CompanyType> findAll() {		 
		...
		return em.createQuery(jpql.toString(),CompanyType.class).getResultList();
	}
