 ...
 */
@Component
public class PublicNoticeConverter extends CustomDozerConverter<PublicNotice, PublicNoticeDto> implements ObjectConverter<PublicNotice, PublicNoticeDto>{
	...
	public PublicNoticeDto convertEntityToDto(PublicNotice entity, Class<PublicNoticeDto> dto) {
		...
		/*publicNoticeDto.setPartner(getParter(entity));*/
		/*publicNoticeDto.setClosingDate(entity.getClosingDate());
		publicNoticeDto.setOpeningDate(entity.getOpeningDate());*/
	...
	private BPartnerDto getParter(PublicNotice entity){
