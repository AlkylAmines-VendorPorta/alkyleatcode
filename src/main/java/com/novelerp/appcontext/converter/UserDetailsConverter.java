...
@Component("USER_DETAILS_CONVERTER")
public class UserDetailsConverter extends CustomContextDozerConverter<UserDetails, UserDetailsDto> implements ObjectConverter<UserDetails, UserDetailsDto>{

	@Autowired
	private DesignationConverterPlain designationConverter;
	
	@Autowired
	private LocationConverterPlain locationConverter;
